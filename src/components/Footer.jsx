...
const socialLinks = [
    {
        name: 'LinkedIn',
        href: 'https://www.linkedin.com/in/eliasshallouf',
        icon: (
    ...
    {
        name: 'GitHub',
        href: 'https://github.com/EliasMShallouf',
        icon: (
    ...
    {
        name: 'Gmail',
        href: 'mailto:elias.m.shallouf@gmail.com',
        icon: (
                ...
                <div className="flex flex-col md:flex-row justify-between items-center gap-6">
                    ...
                    <div className="flex flex-col items-center md:items-start">
                        ...
                        <p className="mt-2 text-slate-500 text-sm">
                            &copy; {new Date().getUTCFullYear()} Viola ORM. All rights reserved.
                        </p>
                    </div>

                    {/* Right side: Author info & Socials */}
                    <div className="flex flex-col items-center md:items-end gap-5">
                        <div className="flex md:items-end items-center gap-4 flex-col-reverse md:flex-row">
